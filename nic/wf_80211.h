...
#define WF_GET_IPV4_IHL(_iphdr)         BE_BITS_TO_1BYTE(((wf_u8 *)(_iphdr)) + 0, 0, 4)
#define WF_GET_IPV4_PROTOCOL(_iphdr)    BE_BITS_TO_1BYTE(((wf_u8 *)(_iphdr)) + 9, 0, 8)
#define WF_GET_IPV4_TOS(_iphdr)         BE_BITS_TO_1BYTE(((wf_u8 *)(_iphdr)) + 1, 0, 8)

#define WF_GET_UDP_SRC(_udphdr)         BE_BITS_TO_2BYTE(((wf_u8 *)(_udphdr)) + 0, 0, 16)
#define WF_GET_UDP_DST(_udphdr)         BE_BITS_TO_2BYTE(((wf_u8 *)(_udphdr)) + 2, 0, 16)

#define WF_TCP_SRC(_tcphdr)             (((wf_u8 *)(_tcphdr)) + 0)
#define WF_TCP_DST(_tcphdr)             (((wf_u8 *)(_tcphdr)) + 2)
#define WF_GET_TCP_FIN(_tcphdr)         BE_BITS_TO_1BYTE(((wf_u8 *)(_tcphdr)) + 13, 0, 1)
#define WF_GET_TCP_SYN(_tcphdr)         BE_BITS_TO_1BYTE(((wf_u8 *)(_tcphdr)) + 13, 1, 1)
#define WF_GET_TCP_ACK(_tcphdr)         BE_BITS_TO_1BYTE(((wf_u8 *)(_tcphdr)) + 13, 4, 1)
...
typedef wf_u8 wf_80211_mgmt_ssid_t[WF_80211_MAX_SSID_LEN + sizeof('\0')];
...
{
    return (addr[0] != 0xFF) && (addr[0] & 0x01);
}
...
{
    return !wf_80211_is_bcast_addr(bssid) &&
