...
#if 1
#define ReadLE4Byte(_ptr)   wf_le32_to_cpu(*((wf_u32 *)(_ptr)))
#define ReadLE2Byte(_ptr)   wf_le16_to_cpu(*((wf_u16 *)(_ptr)))
#define ReadLE1Byte(_ptr)   (*((wf_u8 *)(_ptr)))

#define ReadBEE4Byte(_ptr)  wf_be32_to_cpu(*((wf_u32 *)(_ptr)))
#define ReadBE2Byte(_ptr)   wf_be16_to_cpu(*((wf_u16 *)(_ptr)))
#define ReadBE1Byte(_ptr)   (*((wf_u8 *)(_ptr)))

#define WriteLE4Byte(_ptr, _val)    (*((wf_u32 *)(_ptr))) = wf_cpu_to_le32(_val)
#define WriteLE2Byte(_ptr, _val)    (*((wf_u16 *)(_ptr))) = wf_cpu_to_le16(_val)
#define WriteLE1Byte(_ptr, _val)    (*((wf_u8 *)(_ptr))) = ((wf_u8)(_val))

#define WriteBE4Byte(_ptr, _val)    (*((wf_u32 *)(_ptr))) = wf_cpu_to_be32(_val)
#define WriteBE2Byte(_ptr, _val)    (*((wf_u16 *)(_ptr))) = wf_cpu_to_be16(_val)
#define WriteBE1Byte(_ptr, _val)    (*((wf_u8 *)(_ptr))) = ((wf_u8)(_val))

#define LE_P4BYTE_TO_HOST_4BYTE(__pStart) (wf_le32_to_cpu(*((wf_u32 *)(__pStart))))
#define LE_P2BYTE_TO_HOST_2BYTE(__pStart) (wf_le16_to_cpu(*((wf_u16 *)(__pStart))))
#define LE_P1BYTE_TO_HOST_1BYTE(__pStart) ((*((wf_u8 *)(__pStart))))

#define BE_P4BYTE_TO_HOST_4BYTE(__pStart) (wf_be32_to_cpu(*((wf_u32 *)(__pStart))))
#define BE_P2BYTE_TO_HOST_2BYTE(__pStart) (wf_be16_to_cpu(*((wf_u16 *)(__pStart))))
#define BE_P1BYTE_TO_HOST_1BYTE(__pStart) ((*((wf_u8 *)(__pStart))))

#define BIT_LEN_MASK_32(__BitLen) ((wf_u32)(0xFFFFFFFF >> (32 - (__BitLen))))
#define BIT_LEN_MASK_16(__BitLen) ((wf_u16)(0xFFFF >> (16 - (__BitLen))))
#define BIT_LEN_MASK_8(__BitLen) ((wf_u8)(0xFF >> (8 - (__BitLen))))

#define BIT_OFFSET_LEN_MASK_32(__BitOffset, __BitLen) ((wf_u32)(BIT_LEN_MASK_32(__BitLen) << (__BitOffset)))
#define BIT_OFFSET_LEN_MASK_16(__BitOffset, __BitLen) ((wf_u16)(BIT_LEN_MASK_16(__BitLen) << (__BitOffset)))
#define BIT_OFFSET_LEN_MASK_8(__BitOffset, __BitLen) ((wf_u8)(BIT_LEN_MASK_8(__BitLen) << (__BitOffset)))
...
#define LE_BITS_CLEARED_TO_1BYTE(__pStart, __BitOffset, __BitLen) \
    (LE_P1BYTE_TO_HOST_1BYTE(__pStart) & ((wf_u8)(~BIT_OFFSET_LEN_MASK_8(__BitOffset, __BitLen))))
    ...
    do { \
        if (__BitOffset == 0 && __BitLen == 32) \
            ...
            WriteLE4Byte(__pStart, \
                ...
                | \
                ((((wf_u32)__Value) & BIT_LEN_MASK_32(__BitLen)) << (__BitOffset)) \
            ); \
        } \
    } while (0)
    ...
    do { \
        if (__BitOffset == 0 && __BitLen == 16) \
            ...
            WriteLE2Byte(__pStart, \
                ...
                | \
                ((((wf_u16)__Value) & BIT_LEN_MASK_16(__BitLen)) << (__BitOffset)) \
            ); \
        } \
    } while (0)
    ...
    do { \
        if (__BitOffset == 0 && __BitLen == 8) \
            ...
            WriteLE1Byte(__pStart, \
                ...
                | \
                ((((wf_u8)__Value) & BIT_LEN_MASK_8(__BitLen)) << (__BitOffset)) \
            ); \
        } \
    } while (0)
...
#define WF_N_BYTE_ALIGMENT(__Value, __Aligment)  ((__Aligment == 1) ? (__Value) : (((__Value + __Aligment - 1) / __Aligment) * __Aligment))
#endif
