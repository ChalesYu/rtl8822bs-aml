...
#define GET_IPV4_IHL(_iphdr)        BE_BITS_TO_1BYTE(((wf_u8 *)(_iphdr)) + 0, 0, 4)
#define GET_IPV4_PROTOCOL(_iphdr)   BE_BITS_TO_1BYTE(((wf_u8 *)(_iphdr)) + 9, 0, 8)

#define GET_UDP_SRC(_udphdr)            BE_BITS_TO_2BYTE(((wf_u8 *)(_udphdr)) + 0, 0, 16)
#define GET_UDP_DST(_udphdr)            BE_BITS_TO_2BYTE(((wf_u8 *)(_udphdr)) + 2, 0, 16)

#define TCP_SRC(_tcphdr)                (((wf_u8 *)(_tcphdr)) + 0)
#define TCP_DST(_tcphdr)                (((wf_u8 *)(_tcphdr)) + 2)
#define GET_TCP_FIN(_tcphdr)            BE_BITS_TO_1BYTE(((wf_u8 *)(_tcphdr)) + 13, 0, 1)
#define GET_TCP_SYN(_tcphdr)            BE_BITS_TO_1BYTE(((wf_u8 *)(_tcphdr)) + 13, 1, 1)
#define GET_TCP_ACK(_tcphdr)            BE_BITS_TO_1BYTE(((wf_u8 *)(_tcphdr)) + 13, 4, 1)
typedef enum {
    STA_TO_STA = 0,
    STA_TO_DS  = 1,
    DS_TO_STA  = 2,
