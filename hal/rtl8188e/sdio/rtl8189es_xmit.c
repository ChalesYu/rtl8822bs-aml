...
void rtw_hal_sdio_avail_page_threshold_init(_adapter *adapter)
{
	...
	rtw_write32(adapter, 0x0218, 0xFFFFFFFF);
...
void rtw_sdio_free_xmitbuf_sema_up(struct xmit_priv *xmit)
{
	_rtw_up_sema(&xmit->sdio_free_xmitbuf_sema);
}

void rtw_sdio_free_xmitbuf_sema_down(struct xmit_priv *xmit)
{
