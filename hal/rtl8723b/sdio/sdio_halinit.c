...
void _InitAdaptiveCtrl(PADAPTER padapter)
{
	...
	rtw_write16(padapter, REG_RL_8723B, value16);
}
...
/*For AW H64 platform rf interference issue only!*/
	...
	*	rtw_hal_disable_interrupt(padapter); */
...
#endif /* DBG_CHECK_FW_PS_STATE */ /* Add -- But Maybe Error */
	...
	rtw_write16(padapter, REG_PKT_VO_VI_LIFE_TIME_8723B, 0x0400);	/* unit: 256us. 256ms */
	rtw_write16(padapter, REG_PKT_BE_BK_LIFE_TIME_8723B, 0x0400);	/* unit: 256us. 256ms */
#else	/* CONFIG_TX_MCAST2UNI */
	rtw_write16(padapter, REG_PKT_VO_VI_LIFE_TIME_8723B, 0x3000);	/* unit: 256us. 3s */
	rtw_write16(padapter, REG_PKT_BE_BK_LIFE_TIME_8723B, 0x3000);	/* unit: 256us. 3s */
