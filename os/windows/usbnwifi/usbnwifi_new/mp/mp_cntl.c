        ...
        case IRP_MJ_DEVICE_CONTROL: 
        {
          ...
          switch (irpStack->Parameters.DeviceIoControl.IoControlCode) 
          {
            ...
            case IOCTL_NDISMP_GET_MAC_DATA:
                ...
                switch (data->Size) {
                    case 1:
                    data->Data[0] = HwPlatformEFIORead1Byte(pAdapter,data->Address);
                    break;
    
                    case 2:
                    (*(PUSHORT)(&data->Data)) =HwPlatformEFIORead2Byte(pAdapter,data->Address);
                    break;
    
                    case 4:
                    (*(PULONG)(&data->Data)) = HwPlatformIORead4Byte(pAdapter, data->Address);
              ...
              case IOCTL_NDISMP_SET_MAC_DATA:
                  ...
                  switch (data->Size) {
                      case 1:
                      HwPlatformEFIOWrite1Byte(pAdapter,data->Address,data->Data[0] );
                      break;

                      case 2:
                      HwPlatformEFIOWrite2Byte(pAdapter,data->Address, (*(PUSHORT)(&data->Data)));
                      LOG_D("write value is  %x",(*(PUSHORT)(&data->Data)));
                      break;

                      case 4:
                      HwPlatformIOWrite4Byte(pAdapter, data->Address,(*(PULONG)(&data->Data)) );
              ...
              case IOCTL_NDISMP_GET_CCK_DATA:
                  LOG_D("Received  IOCTL input buffer len %x",inlen);
                  HwPlatformEFIOWrite4Byte(pAdapter, 0xff7c, (0x01000000 | data->Address));
                  data->Data[0]  = HwPlatformEFIORead1Byte(pAdapter, 0xff7e);
                  info = sizeof(NDISMP_GET_DATA);
                  break;
              ...
              case IOCTL_NDISMP_GET_OFDM_DATA:
                  LOG_D("Received  IOCTL input buffer len %x",inlen);
                  HwPlatformEFIOWrite4Byte(pAdapter, 0xff7c, (0x00000000 | data->Address));
                  data->Data[0]  = HwPlatformEFIORead1Byte(pAdapter, 0xff7e);
                  info = sizeof(NDISMP_GET_DATA);
                  break;
