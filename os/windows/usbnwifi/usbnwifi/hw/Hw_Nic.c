                    ...
                    __in  PNIC Nic)
{
    ...
    //
	Nic->RxInfo.ReceiveFilter = NDIS_PACKET_TYPE_DIRECTED |
    ...
    Nic->ManagementInfo.PhyMIB[0].OperationalRateSet.ucRateSet[0] = 0x2 ;
    Nic->ManagementInfo.PhyMIB[0].OperationalRateSet.ucRateSet[1] = 0x4 ;
    Nic->ManagementInfo.PhyMIB[0].OperationalRateSet.ucRateSet[2] = 0xB;
	Nic->ManagementInfo.PhyMIB[0].OperationalRateSet.ucRateSet[3] = 0x0c;
	Nic->ManagementInfo.PhyMIB[0].OperationalRateSet.ucRateSet[4] = 0x12;
	Nic->ManagementInfo.PhyMIB[0].OperationalRateSet.ucRateSet[5] = 0x16 ;
	Nic->ManagementInfo.PhyMIB[0].OperationalRateSet.ucRateSet[6] = 0x18;
	Nic->ManagementInfo.PhyMIB[0].OperationalRateSet.ucRateSet[7] = 0x24;
	Nic->ManagementInfo.PhyMIB[0].OperationalRateSet.ucRateSet[8] = 0x30;
	Nic->ManagementInfo.PhyMIB[0].OperationalRateSet.ucRateSet[9] = 0x48;
	Nic->ManagementInfo.PhyMIB[0].OperationalRateSet.ucRateSet[10] = 0x60;
	Nic->ManagementInfo.PhyMIB[0].OperationalRateSet.ucRateSet[11] = 0x6c;

    Nic->ManagementInfo.PhyMIB[0].OperationalRateSet.uRateSetLength = 12;

	Nic->ManagementInfo.PhyMIB[0].BasicRateSet.ucRateSet[0] = 0x2;
	Nic->ManagementInfo.PhyMIB[0].BasicRateSet.ucRateSet[1] = 0x4;
	Nic->ManagementInfo.PhyMIB[0].BasicRateSet.ucRateSet[2] = 0xB;
	Nic->ManagementInfo.PhyMIB[0].BasicRateSet.ucRateSet[3] = 0x0c;
	Nic->ManagementInfo.PhyMIB[0].BasicRateSet.ucRateSet[4] = 0x12;
	Nic->ManagementInfo.PhyMIB[0].BasicRateSet.ucRateSet[5] = 0x16;
	Nic->ManagementInfo.PhyMIB[0].BasicRateSet.ucRateSet[6] = 0x18;
	Nic->ManagementInfo.PhyMIB[0].BasicRateSet.ucRateSet[7] = 0x24;
	Nic->ManagementInfo.PhyMIB[0].BasicRateSet.ucRateSet[8] = 0x30;
	Nic->ManagementInfo.PhyMIB[0].BasicRateSet.ucRateSet[9] = 0x48;
	Nic->ManagementInfo.PhyMIB[0].BasicRateSet.ucRateSet[10] = 0x60;
	Nic->ManagementInfo.PhyMIB[0].BasicRateSet.ucRateSet[11] = 0x6c;

	Nic->ManagementInfo.PhyMIB[0].BasicRateSet.uRateSetLength = 12;

    Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedTxDataRatesValue[0] = 0x2;
    Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedTxDataRatesValue[1] = 0x4;
    Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedTxDataRatesValue[2] = 0xB;
    Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedTxDataRatesValue[3] = 0x0c;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedTxDataRatesValue[4] = 0x12;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedTxDataRatesValue[5] = 0x16;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedTxDataRatesValue[6] = 0x18;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedTxDataRatesValue[7] = 0x24;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedTxDataRatesValue[8] = 0x30;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedTxDataRatesValue[9] = 0x48;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedTxDataRatesValue[10] = 0x60;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedTxDataRatesValue[11] = 0x6c;


	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedRxDataRatesValue[0] = 0x2;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedRxDataRatesValue[1] = 0x4;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedRxDataRatesValue[2] = 0xB;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedRxDataRatesValue[3] = 0x0c;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedRxDataRatesValue[4] = 0x12;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedRxDataRatesValue[5] = 0x16;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedRxDataRatesValue[6] = 0x18;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedRxDataRatesValue[7] = 0x24;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedRxDataRatesValue[8] = 0x30;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedRxDataRatesValue[9] = 0x48;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedRxDataRatesValue[10] = 0x60;
	Nic->ManagementInfo.PhyMIB[0].SupportedDataRatesValue.ucSupportedRxDataRatesValue[11] = 0x6c;
	...
	Nic->ManagementInfo.pSupportedPhyTypes->dot11PHYType[0] = dot11_phy_type_erp;
//	Nic->ManagementInfo.pSupportedPhyTypes->dot11PHYType[1] = dot11_phy_type_hrdsss;
	Nic->ManagementInfo.PhyMIB[0].PhyType = dot11_phy_type_erp;
//	Nic->ManagementInfo.PhyMIB[1].PhyType = dot11_phy_type_hrdsss;
                ...
                )
{
    ...
    UCHAR                   Rates[8] = {0x82, 0x84, 0x8b, 0x96, 0x8c, 0x92,0x98 ,0xa4};
    UCHAR                   ExRates[4] = {0x30, 0x48, 0x60, 0x6C};
    ...
    if (Nic->ManagementInfo.dot11CurrentWirelessMode == WIRELESS_MODE_A) {
        FillOctetString(os, ExRates, 4);
		PacketMakeElement(&Beacon, EID_SupRates, os);
    }
    else if(Nic->ManagementInfo.dot11CurrentWirelessMode == WIRELESS_MODE_B)
    {
        FillOctetString(os, Rates, 8);
        PacketMakeElement(&Beacon, EID_SupRates, os);
    }
    else  if(Nic->ManagementInfo.dot11CurrentWirelessMode == WIRELESS_MODE_G)//G mode
    {
        FillOctetString(os, Rates, 8);
        PacketMakeElement(&Beacon, EID_SupRates, os);
...
HwHwRateToMRate(
               __in  UCHAR    rate)
{
    static UCHAR RateMap[] = {2, 4, 11, 22, 12, 18, 24, 36, 48, 72, 96, 108, 144,0x7f,0x80,0x81,0x82,0x83,0x84,0x85,0x86,0x87};
         ...
         )
{
    ...
    UCHAR                   Rates[8] = {0x82, 0x84, 0x8b, 0x96, 0x8c, 0x92,0x98 ,0xa4};
    UCHAR                   ExRates[8] = {0x30, 0x48, 0x60, 0x6C};
    ULONGLONG               timeStamp;
    LARGE_INTEGER           ts;
    ...
    if (HwGetTxFreeDescNum(Nic, NORMAL_QUEUE) > 0) {
        ...
        else if(Nic->ManagementInfo.dot11CurrentWirelessMode == WIRELESS_MODE_G)//wirelessmodeG
        {
            FillOctetString(os, Rates, 8);
            PacketMakeElement(&ProbeRsp, EID_SupRates, os);
           ...
           )
{
    ...
    BOOLEAN                 bAnyProbe;
   // UCHAR                   Rates[12] = {0x82, 0x84, 0x8b, 0x96, 0x8c, 0x12, 0x98, 0x24, 0xb0, 0x48, 0x60, 0x6c};
   //UCHAR                   Rates[21] = {0x2,0x4,0xB,0xc,0x12,0x16,0x18,0x24,0x30,0x48,0x60,0x6c,0x7f,0x80,0x81,0x82,0x83,0x84,0x85,0x86,0x87};
                           ...
                           )
{
	...
	if (1 == Nic->ManagementInfo.DestChannel) {
		HwSetParamBeforeScan(Nic);
	}
...
)
{
	...
	workItemContext = GetWorkItemContext(WorkItem);
	Nic = workItemContext->Nic;
	if (Nic->ManagementInfo.KeyProcKeyID != 0xFF) {
		HwAddKeyEntry(Nic, &(Nic->ManagementInfo.KeyProcTable), Nic->ManagementInfo.KeyProcKeyID);
	}
	if (Nic->ManagementInfo.DefKeyProcKeyID != 0xFF) {
		HwAddKeyEntry(Nic, &(Nic->ManagementInfo.DefKeyProcTable), Nic->ManagementInfo.DefKeyProcKeyID);
	}
}
        ...
        )
{
    ...
    if (keyLength != 0) {
        ...
        // Program the hardware.
        //
		Nic->ManagementInfo.KeyMappingKeyCount++;

		switch (algoId) {
		case DOT11_CIPHER_ALGO_WEP:
		case DOT11_CIPHER_ALGO_WEP104:
		case DOT11_CIPHER_ALGO_WEP40:
			NdisMoveMemory(&(Nic->ManagementInfo.KeyProcTable), pNicKey, sizeof(NICKEY));
			Nic->ManagementInfo.KeyProcKeyID = keyIndex;
			break;
		...
		case DOT11_CIPHER_ALGO_TKIP:
			if (keyIndex > 3) {
				...
				NdisMoveMemory(&(Nic->ManagementInfo.DefKeyProcTable), pNicKey, sizeof(NICKEY));
				Nic->ManagementInfo.DefKeyProcKeyID = keyIndex;
				ETH_COPY_NETWORK_ADDRESS(Nic->ManagementInfo.DefKeyProcTable.MacAddr, Nic->ManagementInfo.KeyProcTable.MacAddr);
			}
			break;
		}
	
		WdfWorkItemEnqueue(Nic->ManagementInfo.KeyProcWorkItem);
    }
    else {
        //
