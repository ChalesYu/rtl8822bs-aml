...
int wf_iw_getName(struct net_device *ndev, struct iw_request_info *info, union iwreq_data *wrqu, char *extra);
...
int wf_iw_getRange(struct net_device *ndev, struct iw_request_info *info, union iwreq_data *wrqu, char *extra);
...
int wf_iw_setWap(struct net_device *ndev, struct iw_request_info *info, union iwreq_data *wrqu, char *extra);
...
int wf_iw_setEssid(struct net_device *ndev, struct iw_request_info *info, union iwreq_data *wrqu, char *extra);
...
int wf_iw_setGenIe(struct net_device *ndev, struct iw_request_info *info, union iwreq_data *wrqu, char *extra);
...
int wf_iw_setEncExt(struct net_device *ndev, struct iw_request_info *info, union iwreq_data *wrqu, char *extra);
