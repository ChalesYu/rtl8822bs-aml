...
{
	{IW_PRV_MAC,				   IW_PRIV_TYPE_CHAR | 1024, IW_PRIV_TYPE_CHAR | IW_PRIV_SIZE_MASK, 			  "mac"},
	{IW_PRV_READ_REG_TEST  ,	   IW_PRIV_TYPE_CHAR | 1024, IW_PRIV_TYPE_CHAR | IW_PRIV_SIZE_MASK,              "read_reg"},
    {IW_PRV_WRITE_REG_TEST,	   	   IW_PRIV_TYPE_CHAR | 1024, IW_PRIV_TYPE_CHAR | IW_PRIV_SIZE_MASK,				"write_reg"},
    {IW_PRV_BB,			   		   IW_PRIV_TYPE_CHAR | 1024, IW_PRIV_TYPE_CHAR | IW_PRIV_SIZE_MASK,				"fw"},
	{IW_PRV_FWDL,				   IW_PRIV_TYPE_CHAR | 1024, IW_PRIV_TYPE_CHAR | IW_PRIV_SIZE_MASK,				"tx"},
#ifdef CONFIG_MP_MODE
