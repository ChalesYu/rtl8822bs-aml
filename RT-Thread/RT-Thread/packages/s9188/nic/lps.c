...
static void lps_set_rpwm_hw(nic_info_st *pnic_info, wf_u8 lps_state)
{
    ...
    temp = wf_io_read8(pnic_info, 0xFE78, &error);
...
static void lps_rsvd_page_chip_hw_construct_beacon(nic_info_st *pnic_info, wf_u8 *frame_index_ptr, wf_u32 *length_out)
{
    ...
    *frame_control = 0;
    ...
    SetFrameType(frame_index_ptr, WIFI_BEACON);
...
static void lps_rsvd_page_chip_hw_construct_pspoll(nic_info_st *pnic_info, wf_u8 *frame_index_ptr, wf_u32 *length_out)
{
    ...
    *frame_control = 0;
    ...
    SetFrameSubType(frame_index_ptr, WIFI_PSPOLL);
    SetDuration(frame_index_ptr, cur_network_ptr->aid | 0xC000);
                                      ...
                                      wf_bool is_ps_poll, wf_bool is_bt_qos_null, wf_bool is_dataframe)
{
    ...
    wf_set_bits_to_le_u32(tx_des_start_addr, 27, 1, 1);
    wf_set_bits_to_le_u32(tx_des_start_addr, 26, 1, 1);
    wf_set_bits_to_le_u32(tx_des_start_addr, 16, 8, 0X28);
    wf_set_bits_to_le_u32(tx_des_start_addr, 0, 16, pkt_len);
    wf_set_bits_to_le_u32(tx_des_start_addr+4, 8, 5, QSLT_MGNT);
    ...
    {
        wf_set_bits_to_le_u32(tx_des_start_addr+32, 15, 1, 1);
    ...
    wf_set_bits_to_le_u32(tx_des_start_addr+12, 8, 1, 1);
...
static void lps_set_fw_rsvd_page(nic_info_st *pnic_info)
{
    ...
    wf_u32 page_size = 128;
    struct xmit_frame *cmd_frame_ptr;
    wf_u8 *reserved_page_packet;
    ...
    total_page_number = total_page_number + current_packet_page_num;
    total_packets_len = buff_index + qos_null_length;
    buff_index = buff_index + current_packet_page_num * page_size;
