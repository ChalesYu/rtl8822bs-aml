...
static void wf_hif_tx_work_agg(wf_work_struct *work, void *param)
{
...
static void wf_hif_rx_workqueue(wf_work_struct *work, void *param)
{
...
#ifdef CONFIG_SOFT_TX_AGGREGATION
  static wf_workqueue_func_param_st wq_hif_tx_param   ={"hif_tx",wf_hif_tx_work_agg, NULL};
#endif
  static wf_workqueue_func_param_st wq_hif_rx_param   ={"hif_rx",wf_hif_rx_workqueue, NULL};
  
#ifdef CONFIG_SOFT_TX_AGGREGATION
  wq_hif_tx_param.param = hif_info;
#endif
  wq_hif_rx_param.param = hif_info;
...
#ifdef CONFIG_SOFT_TX_AGGREGATION
  wf_os_api_workqueue_register(&data_queue_mngt->hif_tx_wq,&wq_hif_tx_param);
#endif
  wf_os_api_workqueue_register(&data_queue_mngt->hif_rx_wq,&wq_hif_rx_param);
