...
#define __constant_cpu_to_le64(x) ((  wf_u64)(wf_u64)(x))
#define __constant_le64_to_cpu(x) ((  wf_u64)(wf_u64)(x))
#define __constant_cpu_to_le32(x) ((  wf_u32)(wf_u32)(x))
#define __constant_le32_to_cpu(x) ((  wf_u32)(wf_u32)(x))
#define __constant_cpu_to_le16(x) ((  wf_u16)(wf_u16)(x))
#define __constant_le16_to_cpu(x) ((  wf_u16)(wf_u16)(x))
...
#define WF_HZ                      100//TODO:2021/07/13 wf_win_hz()
