...
static wf_inline
wf_pt_rst_t core_conn_maintain_deauth_thrd (wf_pt_t *pt, nic_info_st *pnic_info)
{
    mlme_info_t *pmlme_info = pnic_info->mlme_info;
    hw_info_st *phw_info = pnic_info->hw_info;
...
static wf_inline
wf_pt_rst_t core_conn_maintain_deassoc_thrd (wf_pt_t *pt, nic_info_st *pnic_info)
{
    mlme_info_t *pmlme_info = pnic_info->mlme_info;
    hw_info_st *phw_info = pnic_info->hw_info;
...
static wf_inline
wf_pt_rst_t core_conn_maintain_ba_req_thrd (wf_pt_t *pt, nic_info_st *pnic_info)
{
    hw_info_st *phw_info = pnic_info->hw_info;
    mlme_info_t *pmlme_info = pnic_info->mlme_info;
    wdn_net_info_st *pwdn_info = pmlme_info->pwdn_info;
...
static wf_inline
wf_pt_rst_t core_conn_maintain_ba_rsp_thrd (wf_pt_t *pt, nic_info_st *pnic_info,
...
wf_inline static
wf_pt_rst_t core_conn_maintain (wf_pt_t *pt, nic_info_st *pnic_info)
{
    mlme_info_t *pmlme_info = pnic_info->mlme_info;
...
wf_inline static
wf_pt_rst_t mlme_conn_clearup (wf_pt_t *pt, nic_info_st *pnic_info)
{
    mlme_info_t *pmlme_info = pnic_info->mlme_info;
