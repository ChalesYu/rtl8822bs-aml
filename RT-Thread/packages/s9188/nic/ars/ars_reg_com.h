...
#ifdef BBW_REG
#define MSR                     (ONE_BACK_REG_CR + 2)       // Media Status register
#else
...
#define IMR_BCNDOK5_88E         BIT(19)       // Beacon Queue DMA OK Interrup 5
...
#define RCR_TIM_PARSER_EN       BIT(19)   // RX Beacon TIM Parser.
...
#define SDIO_HIMR_CPWM1_MSK         BIT(19)
...
#define BT_FUNC_EN              BIT(19)   // BT function enable
