...
static rt_size_t w25qxx_read(struct rt_mtd_nor_device *device, rt_off_t offset, rt_uint8_t *buffer, rt_uint32_t length)
{
    struct spi_flash_mtd *mtd = (struct spi_flash_mtd *)device;
...
static rt_size_t w25qxx_write(struct rt_mtd_nor_device *device, rt_off_t offset, const rt_uint8_t *buffer, rt_uint32_t length)
{
    struct spi_flash_mtd *mtd = (struct spi_flash_mtd *)device;
    rt_uint8_t send_buffer[4];
