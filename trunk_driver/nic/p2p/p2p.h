...
typedef struct p2p_info_st_
{
    ...
    wf_u8 p2p_wildcard_ssid[P2P_WILDCARD_SSID_LEN+1];
    wf_u8 p2p_scan_ssid[P2P_SSID_LEN];
    ...
    wf_bool full_ch_in_p2p_handshake; //copy from registrypriv.full_ch_in_p2p_handshake
