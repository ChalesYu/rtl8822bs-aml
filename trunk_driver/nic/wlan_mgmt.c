                              ...
                              wf_wlan_mgmt_scan_que_node_t *pscan_que_node)
{
    ...
    /* get privacy */
    pscan_que_node->privacy =
        (wf_bool)(!!(pmgmt->beacon.capab & WF_80211_MGMT_CAPAB_PRIVACY));
...
void wf_wlan_set_cur_ssid (nic_info_st *pnic_info, wf_wlan_ssid_t *pssid)
{
    ...
    pwlan_mgmt_info->cur_network.ssid.data[pwlan_mgmt_info->cur_network.ssid.length] = '\0';
}
